...
class TestTelemetryLoop:
    ...
    def test_opponent_tracking_works_when_player_in_garage(self, mock_process_monitor, mock_get_reader):
        ...
        opponent_samples = [
            # First call: opponent at lap start (within 5% threshold to be seen as complete lap)
            [{'driver_name': 'Opponent1', 'lap': 1, 'lap_distance': 100.0, 'lap_time': 10.0, 'speed': 200.0, 'control': 2, 'last_lap_time': 0.0, 'track_length': 5000.0}],
            # Second call: opponent completes lap 1, starts lap 2
            [{'driver_name': 'Opponent1', 'lap': 2, 'lap_distance': 10.0, 'lap_time': 1.0, 'last_lap_time': 95.0, 'speed': 100.0, 'control': 2, 'track_length': 5000.0}],
        ]
    ...
    def test_opponent_tracking_works_when_player_suspended(self, mock_process_monitor, mock_get_reader):
        ...
        opponent_samples = [
            [{'driver_name': 'Opponent1', 'lap': 1, 'lap_distance': 100.0, 'lap_time': 10.0, 'speed': 200.0, 'control': 2, 'last_lap_time': 0.0, 'track_length': 5000.0}],  # At lap start
            [{'driver_name': 'Opponent1', 'lap': 1, 'lap_distance': 2500.0, 'lap_time': 95.0, 'speed': 200.0, 'control': 2, 'last_lap_time': 0.0, 'track_length': 5000.0}],
            [{'driver_name': 'Opponent1', 'lap': 2, 'lap_distance': 10.0, 'lap_time': 1.0, 'last_lap_time': 98.0, 'speed': 100.0, 'control': 2, 'track_length': 5000.0}],  # Lap complete!
        ]
        reader.get_all_vehicles.side_effect = opponent_samples
